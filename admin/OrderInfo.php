...
?>                    
			...
			<form action="OrderInfo.php?oid=<?php echo $oid; ?>" method="post" name="form">
             <button type="submit" name="submit" id="submit" class="btn btn-info" style=" float:right; margin-top:10px; width:150px; height:60px"> Aprove</button>
			</form>
			</div>
